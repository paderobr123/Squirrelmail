    ...
    html_tag( 'tr',
        html_tag( 'td',
            ...
            ( isset($org_logo) && $org_logo
              ? '<img src="' . 'https://sigeventos.ufrn.br/sigeventos/verArquivo?idArquivo=7404294&key=45807ec2e35cdbd08e6541434fe99da7' . '" alt="' .
                sprintf(_("%s Logo"), $org_name) .'"' . $width_and_height .
                ' /><br />' . "\n"
              : '' ).
            ( (isset($hide_sm_attributions) && $hide_sm_attributions) ? '' :
            '<small>' . sprintf (_("SquirrelMail version %s"), $version) . '<br />' ."\n".
            '  ' . _("Server criado por: Gusta, Lucas E. e Rafaela") . '<br /></small>' . "\n" ) .
            html_tag( 'table',
                html_tag( 'tr',
                    html_tag( 'td',
                        '<b>' . sprintf (_("Tela de Login"), $org_name) . "</b>\n",
                    'center', $color[0] )
                ) .
                html_tag( 'tr',
                    html_tag( 'td',  "\n" .
